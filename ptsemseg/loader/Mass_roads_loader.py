...
class Road_Loader(data.Dataset):
    ...
    def setup_annotations(self):
        ...
        expected = np.unique(self.files["trainvaltest"]).size
        ...
        if len(pre_encoded) != expected:
            ...
            for ii in tqdm(self.files["trainvaltest"]):
                fname = ii + ".tif"
        ...
        assert expected == 9084, "unexpected dataset sizes"
